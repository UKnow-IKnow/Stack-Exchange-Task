package com.example.stackexchangetask.adapters
...
import com.example.stackexchangetask.databinding.QuestionItemBinding
import com.example.stackexchangetask.model.Question
import com.example.stackexchangetask.utils.getTime

class QuestionAdapter(private val clickListener: OnClickListener, private val context: Context) :
